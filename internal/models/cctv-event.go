...
type DTO_CCTVEvent_Create struct {
	//Name         string        `json:"name,omitempty"`
	Type         KeyValue      `json:"type,omitempty"`
	SourceDevice KeyValue      `json:"sourceDevice,omitempty"`
	SiteInfo     KeyValue      `json:"siteInfo,omitempty"`
...
type DTO_CCTVEvent_Read_BasicInfo struct {
	ID uuid.UUID `json:"id"`
	//Name         string        `json:"name,omitempty"`
	Type         KeyValue      `json:"type,omitempty"`
	SourceDevice KeyValue      `json:"sourceDevice,omitempty"`
...
type JsonCCTVDeviceTypeRsp struct {
	Code    int        `json:"code"`
...
type JsonCCTVEventTypeRsp struct {
	Code    int        `json:"code"`
	Count   int        `json:"count"`
	Data    []KeyValue `json:"data"`
	Message string     `json:"message,omitempty"`
...
type JsonCCTVEventStatusTypeRsp struct {
	Code    int        `json:"code"`
	Count   int        `json:"count"`
	Data    []KeyValue `json:"data"`
	Message string     `json:"message,omitempty"`
...
type JsonCCTVEventLevelTypeRsp struct {
	Code    int        `json:"code"`
	Count   int        `json:"count"`
	Data    []KeyValue `json:"data"`
	Message string     `json:"message,omitempty"`
